...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        enc2 = self.dp2(self.encoder2(self.dp1(self.pool1(enc1))))
        enc3 = self.dp3(self.encoder3(self.dp2(self.pool2(enc2))))
        enc4 = self.dp4(self.encoder4(self.dp3(self.pool3(enc3))))
        enc5 = self.encoder5(self.dp4(self.pool4(enc4)))
        bottleneck = self.bottleneck(self.dp5(self.pool5(enc5)))
